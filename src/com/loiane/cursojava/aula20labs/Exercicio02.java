	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numerosAleatorios[linha5].length; i++) {
			if (numerosAleatorios[linha5][i] > maiorL5) {
				maiorL5 = numerosAleatorios[linha5][i]; // maior valor >
			}
			if (numerosAleatorios[linha5][i] < menorL5) { // menor valor <
				menorL5 = numerosAleatorios[linha5][i];
			}
		}

		System.out.println("Maior valor da linha 5 = " + maiorL5);
		System.out.println("Menor valor da linha 5 = " + menorL5); // ate aqui é maior e menor da linha 5
